...
void InputManager::Update(void)
{
	...
	oldMouseInput_ = nowMouseInput_;
	nowMouseInput_ = GetMouseInput();
...
bool InputManager::IsRelMouseLeft() const
{
	return (oldMouseInput_ & MOUSE_INPUT_LEFT) &&
		!(nowMouseInput_ & MOUSE_INPUT_LEFT);
}
