...
class ShelfDoor : public Furniture
{
public:
...
public:
    ShelfDoor(const Transform* trans, float rotY, float hingeSide, float openSign);
    virtual ~ShelfDoor() {}
